...
eset <- getGEO(filename = 'GSE118481_series_matrix.txt.gz',getGPL = F)
...
table(group$Group)
group$Group <- ifelse(group$Group=='Asymptomatic','ASYM','SYM')
...
save(GSE118481_cc,GSE118481_ee,file = 'CEA_data/GSE118481.rda')


# -------------------------------------------------------------------------
rm(list = ls())
load('CEA_data/GSE118481.rda')
