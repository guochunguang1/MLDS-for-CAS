...
eset <- getGEO(filename = 'GSE24495_series_matrix.txt.gz',getGPL = F)
...
table(group$Group)
group$Group <- ifelse(group$Group=='carotid plaque','CS','Con')
...
save(GSE24495_cc,GSE24495_ee,file = 'CEA_data/GSE24495.rda')


# -------------------------------------------------------------------------
rm(list = ls())
load('CEA_data/GSE24495.rda')
